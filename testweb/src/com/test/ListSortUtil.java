...
public class ListSortUtil {
    ...
    public static void main(String[] args) throws Exception {
    	List<Beans> records=new ArrayList<Beans>();
    	Beans point=new Beans();
    	point.setAddress("sef");
    	point.setCol1("sfd3");
    	point.setDate(new SimpleDateFormat("yyyy-HH-mm").parse("2015-01-21"));
    	Beans point1=new Beans();
    	point1.setAddress("eef");
    	point1.setCol1("ffd3");
    	point1.setDate(new SimpleDateFormat("yyyy-HH-mm").parse("2015-02-21"));
    	records.add(point);
    	records.add(point1);
    	for(Beans bean:records){
    		System.out.println("Begin：bean:"+bean.getAddress()+","+bean.getCol1()+","+new SimpleDateFormat("yyyy-HH-mm").format(bean.getDate()));
    	}
    	
    	sortList(records,"date","DESC");
    	for(Beans bean:records){
    		System.out.println("bean:"+bean.getAddress()+","+bean.getCol1()+","+new SimpleDateFormat("yyyy-HH-mm").format(bean.getDate()));
    	}
	}
}
