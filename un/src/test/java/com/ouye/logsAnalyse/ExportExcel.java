...
//        comment.setAuthor("dituhui");
    ...
    public void exportPoint(String title, String[] headers,
        ...
        // 遍历集合数据，产生数据行
        SimpleDateFormat sdf = new SimpleDateFormat(pattern);
        List<APIFendanEntity> list=(List<APIFendanEntity>) dataset;
        if(list!=null&&list.size()>0){
        	for(int i=0,s=list.size();i<s;i++){
        		APIFendanEntity point=list.get(i);
        		row = sheet.createRow(i+1);
        		Cell cell=row.createCell(0);
        		cell.setCellStyle(style2);
        		cell.setCellValue(i+1);
        		cell=row.createCell(1);cell.setCellStyle(style2);cell.setCellValue(point.getUserid());
        		cell=row.createCell(2);cell.setCellStyle(style2);cell.setCellValue(sdf.format(point.getFendanTime()));
        		cell=row.createCell(3);cell.setCellStyle(style2);cell.setCellValue(point.getOrderid());
        		cell=row.createCell(4);cell.setCellStyle(style2);cell.setCellValue(point.getAddress());
        		cell=row.createCell(5);cell.setCellStyle(style2);cell.setCellValue(point.getProvince());
        		cell=row.createCell(6);cell.setCellStyle(style2);cell.setCellValue(point.getCity());
        		cell=row.createCell(7);cell.setCellStyle(style2);cell.setCellValue(point.getCounty());
        		cell=row.createCell(8);cell.setCellStyle(style2);cell.setCellValue(point.getAreaid());
        		cell=row.createCell(9);cell.setCellStyle(style2);cell.setCellValue(point.getSmx().doubleValue());
        		cell=row.createCell(10);cell.setCellStyle(style2);cell.setCellValue(point.getSmy().doubleValue());
        		cell=row.createCell(11);cell.setCellStyle(style2);cell.setCellValue(point.getResulttype());
        	}
        }
        for(int j=0;j<12;j++){
        	try {
